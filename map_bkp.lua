...
function newMap(w,h,pos) 
	...
	o.maxx = 512*3 - o.w
	o.maxy = 512*3 - o.h
	if smallMode or (width > 1900) then
		o.maxx = 512*3 - o.w/scaleFactor --TODO
	...
	o.nodered:setFilter("nearest","nearest")
	o.nodegreen:setFilter("nearest","nearest")
	o.nodeblue:setFilter("nearest","nearest")	
	o:updateNodes()
	...
	o.sukiAnim = newAnim(love.graphics.newImage("res/moon.png"), 64, 64, 4, 0.05)
	o.sukiAnim.z = 3
	...
	o.hoshiAnim = newAnim(love.graphics.newImage("res/star.png"), 32, 32, 4, 0.1)
	o.cactusAnim.z = 3
	o.caveAnim.z = 3
	o.palmAnim.z = 3
	o.granAnim.z = 3
	...
	o.testAnim:add(4,31,376)
	o.testAnim:add(4,105,403)
	o.testAnim:add(4,127,417)
	o.testAnim:add(4,170,466)
	
	o.testAnim:add(5,172,404)
	o.testAnim:add(5,144,437)
	o.testAnim:add(5,40,407)
	o.testAnim:add(5,109,466)
	o.testAnim:add(5,50,450)
